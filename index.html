...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">Minh Ngoc</a>

            <div class="nav__menu">
                <ul class="nav__list">
                    <li class="nav__item active">
                        <a href="#home">
                            <span class="menu__icon"><i class='bx bx-home-alt'></i></span>
                            <span class="menu__text">Home</span>
                        </a>
                    </li>
                    <li class="nav__item">
                        <a href="#about">
                            <span class="menu__icon"><i class='bx bx-user'></i></span>
                    ...
                    <li class="nav__item">
                        <a href="#skills">
                            <span class="menu__icon"> <i class='bx bx-book'></i></span>
                    ...
                    <li class="nav__item">
                        <a href="#work">
                            <span class="menu__icon"><i class='bx bxs-briefcase'></i></i></span>
                    ...
                    <li class="nav__item">
                        <a href="#contact">
                            <span class="menu__icon"><i class='bx bx-message-square-dots'></i></span>
    ...
    <main class="main">
        ...
        <section class="home section" id="home">
            <div class="home__container container grid">
                <div class="home__data">
                    ...
                    <h1 class="home__name">Minh Ngoc</h1>
                    <h3 class="home__education">Frontend dev - UI/UX designer</h3>
                ...
                <div class="home__handle">
                    <img src="assets/img/avatar.png" alt="" class="home__img">
                </div>
        ...
        <section class="about section" id="about">
            ...
            <div class="about__container container grid">
                <img src="assets/img/minhngoc.png" alt="" class="about__img">
                ...
                <div class="about__data">
                    <div class="about__info">
                        <div class="about__box">
                            ...
                            <span class="about__subtitle">None</span>
                        </div>

                        <div class="about__box">
                            <i class='bx bx-briefcase about__icon'></i>
                            <h3 class="about__title">Completed</h3>
                            <span class="about__subtitle">2 projects</span>
                        </div>
                    ...
                    <p class="about__description">
                        Frontend developer, i create web pages with UI/UX user interface. I have few months of
                        experience with my projects at university, also i practice at home
                    </p>
                        ...
                        <div class="services__modal-content">
                            ...
                            <ul class="services__modal-list">
                                ...
                                <li class="services__modal-item">
                                    <i class='bx bx-check services__modal-icon'></i>
                                    <p class="services__modal-info">
                                        Design and mockiups of products for companies
                                    </p>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="testimonial section">
            <span class="section__subtitle">My falcuty say</span>
            ...
            <div class="Testimonial__container container swiper">
                <div class="swiper-wrapper">
                    <div class="testimonial__card swiper-slide">
                        ...
                        <h3 class="testimonial__name">Information Technology</h3>
                        <p class="testimonial__description">Your project quite good, friendly interface to interact all
                            users</p>
                    </div>
                ...
                <div class="contact__content">
                    ...
                    <div class="contact__info">
                        <div class="contact__card">
                            ...
                            <a href="mailto:ngocbeo2402@gmail.com" target="_blank" class="contact__button">
                    ...
                    <div class="contact__info">
                        <div class="contact__card">
                            ...
                            <span class="contact__card-data">iuzoeeeee</span>
    ...
    <footer class="footer">
        <div class="footer__container container">
            <h1 class="footer__title">@ copyright by Minh Ngoc</h1>
